...
This package (`tsne663`) can be installed from TestPyPI using `pip install -i https://test.pypi.org/simple/ tsne663==0.3`. Alternatively, one can navigate to this Github repository and run `python setup.py install`. 
