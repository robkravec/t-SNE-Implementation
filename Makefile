writeup.pdf: writeup.ipynb data/plots/plot1 data/plots/plot2
	jupyter nbconvert --to pdf --no-input writeup.ipynb
   
data/plots/plot2: data/humanM1_10x/matrix.csv data/humanM1_10x/metadata.csv data/TCGA-PANCAN-HiSeq-801x20531/data.csv data/TCGA-PANCAN-HiSeq-801x20531/labels.csv data/makeplot2.py
	mkdir -p data/plots
	cd data; python3 makeplot2.py

data/plots/plot1: data/coil-20-proc/X_COIL.npy data/coil-20-proc/y_COIL.csv data/mnist/X_MNIST.npy data/mnist/y_MNIST.npy data/makeplot1.py
	mkdir -p data/plots
